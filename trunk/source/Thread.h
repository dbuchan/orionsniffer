...
ThreadID createThread(ThreadProc startProc, void *param);
void deleteThread(ThreadID thread);
void waitOnThread(const ThreadID threadID);
void waitOnAllThreads(const ThreadID *threads, const int nThreads);
void waitOnAnyThread(const ThreadID *threads, const int nThreads);
